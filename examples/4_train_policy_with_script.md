...
LeRobot offers a training script at [`lerobot/scripts/lerobot_train.py`](../../lerobot/scripts/lerobot_train.py). At a high level it does the following:
...
```bash
python lerobot/scripts/lerobot_train.py --config_path=lerobot/diffusion_pusht
```
